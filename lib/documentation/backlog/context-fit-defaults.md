...
**Scope note.** Phase 4, item **25a**; gated on nothing, and the `common_fit_params` step follows 24b. Out of scope: offloading the cache to system memory, and per-conversation windows.
