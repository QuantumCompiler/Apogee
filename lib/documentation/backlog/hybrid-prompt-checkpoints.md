...
**Scope note.** Phase 4, item **24c**; build after 24b. Out of scope: persisting checkpoints to disk across processes (a resumed chat re-reads once), and speculative-decoding checkpoints.
