...
*Items 1 (C++ project skeleton) and 2 (config engine) shipped 2026-08-25 — see [MILESTONES.md](../assistant/MILESTONES.md) → Milestones A and B. The numbering below is unchanged so the gate references in each document still read true.*

| # | Document | Build after | What |
|---|---|---|---|
| 3 | [harness-core.md](harness-core.md) | ✅ 2 (shipped) | Harness core: LLMProvider interface, canonical message IR, router |
