...
- [ ] (conditional — applies once model-profiles lands) Streaming think/format filtering on server paths uses continue-not-break semantics (an empty filtered chunk ≠ end of stream)
