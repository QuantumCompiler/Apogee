...
**Scope note.** Item **26k**; build after 25c (25b, which linked `llama-common`, shipped 2026-09-25). The build half is conditional on the measurement. Out of scope: training a draft model, and EAGLE-style heads that need separate weights.
