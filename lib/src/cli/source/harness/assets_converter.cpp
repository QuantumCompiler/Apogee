...
const std::string& convert_conversion_init_py() {
    static const std::string text = join(kConvertConversionInitPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionAfmoePy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_afmoe_py() {
    static const std::string text = join(kConvertConversionAfmoePy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionArcticPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_arctic_py() {
    static const std::string text = join(kConvertConversionArcticPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionBaichuanPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_baichuan_py() {
    static const std::string text = join(kConvertConversionBaichuanPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionBailingmoePy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_bailingmoe_py() {
    static const std::string text = join(kConvertConversionBailingmoePy);
    return text;
}
...
const std::string& convert_conversion_base_py() {
    static const std::string text = join(kConvertConversionBasePy);
    return text;
}

constexpr std::array<std::string_view, 2> kConvertConversionBertPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_bert_py() {
    static const std::string text = join(kConvertConversionBertPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionBitnetPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_bitnet_py() {
    static const std::string text = join(kConvertConversionBitnetPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionBloomPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_bloom_py() {
    static const std::string text = join(kConvertConversionBloomPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionChameleonPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_chameleon_py() {
    static const std::string text = join(kConvertConversionChameleonPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionChatglmPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_chatglm_py() {
    static const std::string text = join(kConvertConversionChatglmPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionCodeshellPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_codeshell_py() {
    static const std::string text = join(kConvertConversionCodeshellPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionCogvlmPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_cogvlm_py() {
    static const std::string text = join(kConvertConversionCogvlmPy);
    return text;
}
...
const std::string& convert_conversion_command_r_py() {
    static const std::string text = join(kConvertConversionCommandRPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionDbrxPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_dbrx_py() {
    static const std::string text = join(kConvertConversionDbrxPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionDeciPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_deci_py() {
    static const std::string text = join(kConvertConversionDeciPy);
    return text;
}
...
const std::string& convert_conversion_deepseek_py() {
    static const std::string text = join(kConvertConversionDeepseekPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionDots1Py{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_dots1_py() {
    static const std::string text = join(kConvertConversionDots1Py);
    return text;
}
...
const std::string& convert_conversion_dotsocr_py() {
    static const std::string text = join(kConvertConversionDotsocrPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionDreamPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_dream_py() {
    static const std::string text = join(kConvertConversionDreamPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionErniePy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_ernie_py() {
    static const std::string text = join(kConvertConversionErniePy);
    return text;
}
...
const std::string& convert_conversion_exaone_py() {
    static const std::string text = join(kConvertConversionExaonePy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionFalconPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_falcon_py() {
    static const std::string text = join(kConvertConversionFalconPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionFalconH1Py{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_falcon_h1_py() {
    static const std::string text = join(kConvertConversionFalconH1Py);
    return text;
}
...
const std::string& convert_conversion_gemma_py() {
    static const std::string text = join(kConvertConversionGemmaPy);
    return text;
}
...
const std::string& convert_conversion_glm_py() {
    static const std::string text = join(kConvertConversionGlmPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionGpt2Py{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_gpt2_py() {
    static const std::string text = join(kConvertConversionGpt2Py);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionGptOssPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_gpt_oss_py() {
    static const std::string text = join(kConvertConversionGptOssPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionGptneoxPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_gptneox_py() {
    static const std::string text = join(kConvertConversionGptneoxPy);
    return text;
}
...
const std::string& convert_conversion_granite_py() {
    static const std::string text = join(kConvertConversionGranitePy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionGrokPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_grok_py() {
    static const std::string text = join(kConvertConversionGrokPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionGrovemoePy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_grovemoe_py() {
    static const std::string text = join(kConvertConversionGrovemoePy);
    return text;
}
...
constexpr std::array<std::string_view, 1> kConvertConversionInternlmPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_internlm_py() {
    static const std::string text = join(kConvertConversionInternlmPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionInternvlPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_internvl_py() {
    static const std::string text = join(kConvertConversionInternvlPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionJaisPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_jais_py() {
    static const std::string text = join(kConvertConversionJaisPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionJambaPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_jamba_py() {
    static const std::string text = join(kConvertConversionJambaPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionJanusproPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_januspro_py() {
    static const std::string text = join(kConvertConversionJanusproPy);
    return text;
}
...
const std::string& convert_conversion_kimi_linear_py() {
    static const std::string text = join(kConvertConversionKimiLinearPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionKimivlPy{{
    R"CONV(from __future__ import annotations
...
constexpr std::array<std::string_view, 1> kConvertConversionLfm2Py{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_lfm2_py() {
    static const std::string text = join(kConvertConversionLfm2Py);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionLightonOcrPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_lighton_ocr_py() {
    static const std::string text = join(kConvertConversionLightonOcrPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionLladaPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_llada_py() {
    static const std::string text = join(kConvertConversionLladaPy);
    return text;
}
...
const std::string& convert_conversion_llama_py() {
    static const std::string text = join(kConvertConversionLlamaPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionLlama4Py{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_llama4_py() {
    static const std::string text = join(kConvertConversionLlama4Py);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionLlavaPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_llava_py() {
    static const std::string text = join(kConvertConversionLlavaPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionMaincoderPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_maincoder_py() {
    static const std::string text = join(kConvertConversionMaincoderPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionMambaPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_mamba_py() {
    static const std::string text = join(kConvertConversionMambaPy);
    return text;
}
...
const std::string& convert_conversion_mimo_py() {
    static const std::string text = join(kConvertConversionMimoPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionMinicpmPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_minicpm_py() {
    static const std::string text = join(kConvertConversionMinicpmPy);
    return text;
}
...
const std::string& convert_conversion_minimax_py() {
    static const std::string text = join(kConvertConversionMinimaxPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionMistralPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_mistral_py() {
    static const std::string text = join(kConvertConversionMistralPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionMistral3Py{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_mistral3_py() {
    static const std::string text = join(kConvertConversionMistral3Py);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionMptPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_mpt_py() {
    static const std::string text = join(kConvertConversionMptPy);
    return text;
}
...
const std::string& convert_conversion_nemotron_py() {
    static const std::string text = join(kConvertConversionNemotronPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionOlmoPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_olmo_py() {
    static const std::string text = join(kConvertConversionOlmoPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionOpenelmPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_openelm_py() {
    static const std::string text = join(kConvertConversionOpenelmPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionOrionPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_orion_py() {
    static const std::string text = join(kConvertConversionOrionPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionPanguPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_pangu_py() {
    static const std::string text = join(kConvertConversionPanguPy);
    return text;
}

constexpr std::array<std::string_view, 2> kConvertConversionPhiPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_phi_py() {
    static const std::string text = join(kConvertConversionPhiPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionPixtralPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_pixtral_py() {
    static const std::string text = join(kConvertConversionPixtralPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionPlamoPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_plamo_py() {
    static const std::string text = join(kConvertConversionPlamoPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionPlmPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_plm_py() {
    static const std::string text = join(kConvertConversionPlmPy);
    return text;
}
...
constexpr std::array<std::string_view, 2> kConvertConversionQwen3vlPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_qwen3vl_py() {
    static const std::string text = join(kConvertConversionQwen3vlPy);
    return text;
}
...
const std::string& convert_conversion_qwenvl_py() {
    static const std::string text = join(kConvertConversionQwenvlPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionRefactPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_refact_py() {
    static const std::string text = join(kConvertConversionRefactPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionRwkvPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_rwkv_py() {
    static const std::string text = join(kConvertConversionRwkvPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionSarashina2Py{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_sarashina2_py() {
    static const std::string text = join(kConvertConversionSarashina2Py);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionSmallthinkerPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_smallthinker_py() {
    static const std::string text = join(kConvertConversionSmallthinkerPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionSmolvlmPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_smolvlm_py() {
    static const std::string text = join(kConvertConversionSmolvlmPy);
    return text;
}
...
const std::string& convert_conversion_stablelm_py() {
    static const std::string text = join(kConvertConversionStablelmPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionStarcoderPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_starcoder_py() {
    static const std::string text = join(kConvertConversionStarcoderPy);
    return text;
}
...
const std::string& convert_conversion_step3_py() {
    static const std::string text = join(kConvertConversionStep3Py);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionT5Py{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_t5_py() {
    static const std::string text = join(kConvertConversionT5Py);
    return text;
}
...
const std::string& convert_conversion_ultravox_py() {
    static const std::string text = join(kConvertConversionUltravoxPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionWavtokenizerPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_wavtokenizer_py() {
    static const std::string text = join(kConvertConversionWavtokenizerPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionXversePy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_xverse_py() {
    static const std::string text = join(kConvertConversionXversePy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConversionYoutuvlPy{{
    R"CONV(from __future__ import annotations
...
const std::string& convert_conversion_youtuvl_py() {
    static const std::string text = join(kConvertConversionYoutuvlPy);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertConvertHfToGgufPy{{
    R"CONV(#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
const std::string& convert_convert_hf_to_gguf_py() {
    static const std::string text = join(kConvertConvertHfToGgufPy);
    return text;
}
...
constexpr std::array<std::string_view, 1> kConvertModelsTemplatesLlamaCppRwkvWorldJinja{{
...
const std::string& convert_models_templates_llama_cpp_rwkv_world_jinja() {
    static const std::string text = join(kConvertModelsTemplatesLlamaCppRwkvWorldJinja);
    return text;
}

constexpr std::array<std::string_view, 1> kConvertModelsTemplatesUnslothMistralDevstralSmall2507Jinja{{
    R"CONV({#- Copyright 2025-present the Unsloth team. All rights reserved. #}
...
{#- Licensed under the Apache License, Version 2.0 (the "License") #})CONV",
}};

const std::string& convert_models_templates_unsloth_mistral_devstral_small_2507_jinja() {
    static const std::string text = join(kConvertModelsTemplatesUnslothMistralDevstralSmall2507Jinja);
    return text;
}
...
std::span<const BundledScript> bundled_converter_files() {
    static const std::array<BundledScript, 83> files{{
        ...
        {.name = "convert/conversion/bloom.py", .text = convert_conversion_bloom_py()},
        {.name = "convert/conversion/chameleon.py", .text = convert_conversion_chameleon_py()},
        {.name = "convert/conversion/chatglm.py", .text = convert_conversion_chatglm_py()},
        {.name = "convert/conversion/codeshell.py", .text = convert_conversion_codeshell_py()},
        {.name = "convert/conversion/cogvlm.py", .text = convert_conversion_cogvlm_py()},
        {.name = "convert/conversion/command_r.py", .text = convert_conversion_command_r_py()},
        {.name = "convert/conversion/dbrx.py", .text = convert_conversion_dbrx_py()},
        ...
        {.name = "convert/conversion/exaone.py", .text = convert_conversion_exaone_py()},
        {.name = "convert/conversion/falcon.py", .text = convert_conversion_falcon_py()},
        {.name = "convert/conversion/falcon_h1.py", .text = convert_conversion_falcon_h1_py()},
        {.name = "convert/conversion/gemma.py", .text = convert_conversion_gemma_py()},
        {.name = "convert/conversion/glm.py", .text = convert_conversion_glm_py()},
        {.name = "convert/conversion/gpt2.py", .text = convert_conversion_gpt2_py()},
        {.name = "convert/conversion/gpt_oss.py", .text = convert_conversion_gpt_oss_py()},
        {.name = "convert/conversion/gptneox.py", .text = convert_conversion_gptneox_py()},
        ...
        {.name = "convert/conversion/llama.py", .text = convert_conversion_llama_py()},
        {.name = "convert/conversion/llama4.py", .text = convert_conversion_llama4_py()},
        ...
        {.name = "convert/conversion/orion.py", .text = convert_conversion_orion_py()},
        {.name = "convert/conversion/pangu.py", .text = convert_conversion_pangu_py()},
        {.name = "convert/conversion/phi.py", .text = convert_conversion_phi_py()},
        ...
        {.name = "convert/conversion/youtuvl.py", .text = convert_conversion_youtuvl_py()},
        {.name = "convert/convert_hf_to_gguf.py", .text = convert_convert_hf_to_gguf_py()},
