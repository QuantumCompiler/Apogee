...
# fetch_url is asked about per website instead: see allowed_hosts below.
permissions:
  write_file: ask
  delete_file: ask
  run_command: ask
...
# Where the native toolsets operate, and which websites they may reach.
tools:
  ...
  # it is refused. The prompt's [a]lways answer adds the website here.
  allowed_hosts: []
